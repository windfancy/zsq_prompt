'''
原始代码来自 https://github.com/chflame163/ComfyUI_LayerStyle
'''
...
from .libs.segment_anything_func import *
...
def get_a_person_mask_generator_model_path() -> str:
    ...
    if not os.path.exists(model_file_path):
        ...
        print(f"model_file_path:{model_file_path} no model")
...
class PersonMaskUltraV2:
    ...
    def person_mask_ultra_v2(self, images, face, hair, body, clothes,
        ...
        with mp.tasks.vision.ImageSegmenter.create_from_options(options) as segmenter:
            ...
            print(f"{NODE_NAME} Processed {len(ret_images)} image(s).")
